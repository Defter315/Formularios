...
<html lang="en">
  ...
  <body>
   ...
   <div class="col-md-12">
        ...
        <h2>AGREGAR RECETA</h2><br>
        <fieldset class="formulario" id="formulario">
        <h5 style="font-weight:bold;"></h5><br>
        <div class="row">
          <div class="col-4">
          <label for="" class="form-label">Nombre</label>
          <input type="text" class="form-control" id="nuemero_mesa" aria-describedby="" required>
          </div>
          <div class="col-4">
          ...
          <input type="number" class="form-control" id="nuemero_mesa" aria-describedby="" required>
         </div>
        </div> <br>
        <div class="mb-3">
